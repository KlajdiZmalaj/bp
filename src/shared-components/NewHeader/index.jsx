...
class Header extends Component {
    ...
    render() {
        const { accountInfo, screenWidth } = this.props
            ...
            <header className="header">
                <div className="headermaxW">
                    <div className="topNav">
                        <div className="left">
                            <div><i className="fal fa-phone"></i> +39 1231313</div>
                            <div><i className="fal fa-envelope"></i>info@bpoint.store</div>
                        </div>
                        <div className="right">
                            <div className="icons">
                                <div>
                ...
                <div className="top">
                    <button onClick={this.toggleMobileMeu}><i className="fal fa-bars"></i></button>
                    <div className="logo">
                        <img src={images.logo} alt="" />
                    </div>
                </div>
