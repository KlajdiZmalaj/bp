...
const FaturaDomain = () => {
  return (
    <div className="Fatura">
      <img className="Fatura--Background" src={images.faturaBackground} />
      <div className="Head">
        <img className="Fatura--Logo" src={images.logo} />
        <div className="Fatura--RightPart">
          <p>
            COORDINATE BANCARIE: UNICREDIT: Mape di Hristova Mariya Hristova e
            C. sas IBAN: IT24J0200824203000100898936 Numero C/C 000100898936 -
            BIC/SWIFT UNCRITM1SR2 POSTE ITALIANE: Mape sas IBAN:
            IT35A0760113200001048987398 Numero C/C 001048987398 - BIC/SWIFT
            BPPIITRRXXX
          </p>
        </div>
      </div>
      ...
      <div className="Fatura--Body">
        <div className="Fatura--Body--TopPart">
          ...
          <div className="Fatura--Body--TopPart--Right">
            <span className="head">PUNTA ANCORA DI GALASSI GABRIELE</span>
            <span className="data">
              Via del Lavoro 29/c - 40026, Imola (BO)
            </span>
            <span className="data">C.F./P. Iva: 03288131208</span>
            <span className="data">Cod. cliente: 022214</span>
          </div>
        </div>
        ...
        <div className="Fatura--Body--BottomPart">
          ...
          <div className="Fatura--Body--BottomPart--Right">
            <span className="Data">€ 1.843,25</span>
            <span className="Data">2,00</span>
            <span className="Data">€ 1.845,25</span>
          </div>
        </div>
      </div>
      <div className="Fatura--Body--BeforeFooter">
        <div>
          ...
          B=Es.10 Imposta di bollo assolta in modo virtuale da Mape C.s.a.s. /
          Autorizzazione dellʼAgenzia delle Entrate Ufficio di Rimini ....
        </div>
        <div>Pagina 1/1</div>
      </div>
      <div className="Fatura--footer">
        <div className="Fatura--footer--Left">
          ...
          <div>
            ...
            <span>
              Viale XXIII Settembre 1845 n. 67, 47921 Rimini - ITALIA +39 0541
              087890
            </span>
          </div>
          <div>
            <span>@</span>
            <span>info@bpoint.store bpoint.store</span>
          </div>
        </div>
