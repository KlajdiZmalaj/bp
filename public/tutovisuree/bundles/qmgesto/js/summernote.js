...
(function (factory) {
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      picture: function (lang) {
        return tplIconButton('fas fa-image', {
      ...
      link: function (lang) {
        return tplIconButton('fas fa-link', {
      ...
      style: function (lang, options) {
        ...
        return tplIconButton('fas fa-magic', {
      ...
      color: function (lang) {
        var colorButtonLabel = '<i class="fas fa-font" style="color:black;background-color:yellow;"></i>';
      ...
      bold: function (lang) {
        return tplIconButton('fas fa-bold', {
          event: 'bold',
          title: lang.font.bold
        });
      },
      italic: function (lang) {
        return tplIconButton('fas fa-italic', {
          event: 'italic',
          title: lang.font.italic
        });
      },
      underline: function (lang) {
        return tplIconButton('fas fa-underline', {
          event: 'underline',
          title: lang.font.underline
        });
      },
      clear: function (lang) {
        return tplIconButton('fas fa-eraser', {
          event: 'removeFormat',
          title: lang.font.clear
        });
      },
      ul: function (lang) {
        return tplIconButton('fas fa-list-ul', {
          event: 'insertUnorderedList',
          title: lang.lists.unordered
        });
      },
      ol: function (lang) {
        return tplIconButton('fas fa-list-ol', {
          event: 'insertOrderedList',
          title: lang.lists.ordered
        });
      },
      paragraph: function (lang) {
        var leftButton = tplIconButton('fas fa-align-left', {
          title: lang.paragraph.left,
          event: 'justifyLeft'
        });
        var centerButton = tplIconButton('fas fa-align-center', {
          title: lang.paragraph.center,
          event: 'justifyCenter'
        });
        var rightButton = tplIconButton('fas fa-align-right', {
          title: lang.paragraph.right,
          event: 'justifyRight'
        });
        var justifyButton = tplIconButton('fas fa-align-justify', {
          title: lang.paragraph.justify,
          event: 'justifyFull'
        });

        var outdentButton = tplIconButton('fas fa-outdent', {
          title: lang.paragraph.outdent,
          event: 'outdent'
        });
        var indentButton = tplIconButton('fas fa-indent', {
        ...
        return tplIconButton('fas fa-align-left', {
      ...
      height: function (lang, options) {
        ...
        return tplIconButton('fas fa-text-height', {
      ...
      help: function (lang) {
        return tplIconButton('fas fa-question', {
      ...
      fullscreen: function (lang) {
        return tplIconButton('fas fa-arrows-alt', {
          event: 'fullscreen',
          title: lang.options.fullscreen
        });
      },
      codeview: function (lang) {
        return tplIconButton('fas fa-code', {
          event: 'codeview',
          title: lang.options.codeview
        });
      },
      undo: function (lang) {
        return tplIconButton('fas fa-undo', {
          event: 'undo',
          title: lang.history.undo
        });
      },
      redo: function (lang) {
        return tplIconButton('fas fa-redo', {
          event: 'redo',
          title: lang.history.redo
        });
      },
      hr: function (lang) {
        return tplIconButton('fas fa-minus', {
    ...
    var tplPopovers = function (lang, options) {
      var tplLinkPopover = function () {
        var linkButton = tplIconButton('far fa-edit', {
          title: lang.link.edit,
          event: 'showLinkDialog',
          hide: true
        });
        var unlinkButton = tplIconButton('fas fa-unlink', {
      ...
      var tplImagePopover = function () {
        ...
        var roundedButton = tplIconButton('fas fa-square', {
        ...
        var thumbnailButton = tplIconButton('fas fa-image', {
        ...
        var removeButton = tplIconButton('fas fa-trash-alt', {
   ...
   *            return tmpl.iconButton('fas fa-heading', {
