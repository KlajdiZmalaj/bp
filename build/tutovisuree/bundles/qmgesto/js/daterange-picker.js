    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (this.showWeekNumbers)
                html += '<th><i class="caret"></i></th>';

            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="fas fa-arrow-left icon-arrow-left glyphicon glyphicon-arrow-left"></i><i class="caret"></i></th>';
            } else {
                html += '<th><i class="caret"></i></th>';
            }
            ...
            html += '<th colspan="5" class="month">' + dateHtml + '<i class="caret"></i></th>';
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="fas fa-arrow-right icon-arrow-right glyphicon glyphicon-arrow-right"></i><i class="caret"></i></th>';
            } else {
                html += '<th><i class="caret"></i></th>';
            }
            ...
            if (this.showWeekNumbers)
                html += '<th class="week">' + this.locale.weekLabel + '<i class="caret"></i></th>';

            $.each(this.locale.daysOfWeek, function (index, dayOfWeek) {
                html += '<th>' + dayOfWeek + '<i class="caret"></i></th>';
            });
