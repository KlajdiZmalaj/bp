$(window).on('load', function() {
    if ($("#certificato_di_esistenza_in_vita_ordine_cliente_tipoCliente").length || $("#certificato_di_esistenza_in_vita_ordine_tipoCheckOut").length) {
        setTimeout (function () {
...
$(document).ready(function(){
    $("#certificato_di_esistenza_in_vita_ordine_datiProdotto_provincia").change(function() {
        Tuttovisure.provinciaComune($(this), "#certificato_di_esistenza_in_vita_ordine_datiProdotto_comune");
    });
    ...
    $("input[name$='certificato_di_esistenza_in_vita_ordine[spedizione][spedizione_nazionale]']").change(function () {
    ...
    if ($("#certificato_di_esistenza_in_vita_ordine_spedizione_spedizione_nazionale_3").is(':checked')) {
        $('.spedizione_internazionale').removeClass('hidden');
        $('.spedizione_internazionale').children('.form-control').removeClass('hidden');
        $('.spedizione_internazionale').find('input:radio').prop('required', true);
    } else {
